...
DROP TABLE t_session_lookup_2021;

CREATE TABLE t_session_lookup_2021 (
...
CREATE TABLE t_car_telemetry_data_2021 (
  ...
  CONSTRAINT t_car_telemetry_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_car_status_data_2021 (
  ...
  CONSTRAINT t_car_status_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_lap_data_2021 (
  ...
  CONSTRAINT t_lap_data_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_participant_data_2021 (
  ...
  CONSTRAINT t_participant_data_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_car_setup_data_2021 (
  ...
  CONSTRAINT t_car_setup_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_car_motion_data_2021 (
  ...
  CONSTRAINT t_car_motion_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_car_motion_data_player_2021 (
  ...
  CONSTRAINT t_player_car_motion_data_2021_fk FOREIGN KEY (m_car_motion_data_id) REFERENCES t_car_motion_data_2021 (id)
); 
...
CREATE TABLE t_session_data_2021 (
  ...
  CONSTRAINT t_session_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_final_classification_data_2021 (
  ...
  CONSTRAINT t_final_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_car_damage_data_2021 (
  ...
  CONSTRAINT t_damage_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_session_history_data_2021 (
  ...
  CONSTRAINT t_session_history_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES t_session_lookup_2021 (id)
);
...
CREATE TABLE t_track_coordinates_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_track_id VARCHAR2(100),
