...
CREATE TABLE F12021.t_session_lookup_2021 (
  ...
  m_event_id NUMBER,
  CONSTRAINT t_session_lookup_2021_pk PRIMARY KEY (id),
  CONSTRAINT t_session_lookup_event_fk FOREIGN KEY (m_event_id) REFERENCES F12021.t_event (id),
  CONSTRAINT unique_session_lookup_2021 UNIQUE (m_session_UID, m_frame_identifier, m_session_time)
);

CREATE TABLE F12021.t_packet_header_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_player_name VARCHAR2(100),
...
CREATE TABLE F12021.t_car_telemetry_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_packet_id NUMBER,
  m_session_lookup_id NUMBER,
  m_index NUMBER,
  m_speed NUMBER,
  m_throttle NUMBER,
  m_steer NUMBER,
  ...
  CONSTRAINT t_car_telemetry_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_car_telemetry_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_car_status_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_packet_id NUMBER,
  m_session_lookup_id NUMBER,
  m_index NUMBER,
  ...
  CONSTRAINT t_car_status_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_car_status_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_lap_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_index NUMBER,
  m_packet_id NUMBER,
  m_session_lookup_id NUMBER,
  ...
  CONSTRAINT t_lap_data_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_lap_data_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_participant_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_index NUMBER,
  m_packet_id NUMBER,
  m_session_lookup_id NUMBER,
  ...
  CONSTRAINT t_participant_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_participant_data_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_car_setup_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_packet_id NUMBER,
  m_index NUMBER,
  m_session_lookup_id NUMBER,
  ...
  CONSTRAINT t_car_setup_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_car_setup_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_car_motion_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_packet_id NUMBER,
  m_index NUMBER,
  m_session_lookup_id NUMBER,
  ...
  CONSTRAINT t_car_motion_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_car_motion_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_car_motion_data_player_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  ...
  CONSTRAINT t_player_car_motion_data_2021_fk FOREIGN KEY (m_car_motion_data_id) REFERENCES F12021.t_car_motion_data_2021 (id)
); 

CREATE TABLE F12021.t_session_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  ...
  CONSTRAINT t_session_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_session_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_marshal_zone_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_session_data_id NUMBER,
  m_zone_start NUMBER,
  m_zone_flag VARCHAR2(100),
  CONSTRAINT t_marshal_zone_2021_pk PRIMARY KEY (id),
  CONSTRAINT t_session_data_marshal_2021_fk FOREIGN KEY (m_session_data_id) REFERENCES F12021.t_session_data_2021 (id)
);


CREATE TABLE F12021.t_weather_forecast_samples_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_session_data_id NUMBER,
  m_session_type VARCHAR2(100),
  ...
  CONSTRAINT t_session_data_weather_2021_fk FOREIGN KEY (m_session_data_id) REFERENCES F12021.t_session_data_2021 (id)
);

CREATE TABLE F12021.t_final_classification_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_packet_id NUMBER NOT NULL,
  m_session_lookup_id NUMBER,
  m_position NUMBER,
  ...
  CONSTRAINT t_final_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_final_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_car_damage_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_packet_id NUMBER NOT NULL,
  m_index NUMBER,
  m_session_lookup_id NUMBER,
  ...
  CONSTRAINT t_damage_packet_2021_fk FOREIGN KEY (m_packet_id) REFERENCES F12021.t_packet_header_2021 (id),
  CONSTRAINT t_damage_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_session_history_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_session_UID VARCHAR2(200) NOT NULL,
  ...
  CONSTRAINT t_session_history_session_lookup_2021_fk FOREIGN KEY (m_session_lookup_id) REFERENCES F12021.t_session_lookup_2021 (id)
);

CREATE TABLE F12021.t_lap_history_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE F12021.t_tyre_stint_history_data_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_session_history_id NUMBER NOT NULL,
  ...
  CONSTRAINT t_tyre_stint_history_2021_fk FOREIGN KEY (m_session_history_id) REFERENCES F12021.t_session_history_data_2021 (id)
);

CREATE TABLE F12021.t_track_coordinates_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_track_id VARCHAR2(100),
  m_track_type VARCHAR(100),
  m_volume_id NUMBER,
  m_point_1_y NUMBER,
  m_point_1_z NUMBER,
  m_point_1_x NUMBER,
  ...
  m_point_4_z NUMBER,
  m_point_4_x NUMBER,
  CONSTRAINT t_track_coordinates_2021_pk PRIMARY KEY (id),
  UNIQUE (m_track_id, m_track_type, m_volume_id)
);

CREATE TABLE F12021.t_track_corner_2021 (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_track_id VARCHAR2(100),
  m_corner NUMBER,
  m_apex_1 NUMBER,
  ...
  m_x NUMBER,
  m_y NUMBER,
  CONSTRAINT t_track_corner_2021_pk PRIMARY KEY (id),
  UNIQUE (m_track_id, m_corner)
);

CREATE TABLE F12021.t_event (
  id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  m_name VARCHAR2(100),
  m_start_date TIMESTAMP,
  m_end_date TIMESTAMP,
  CONSTRAINT t_event_pk PRIMARY KEY (id),
  UNIQUE (m_name)
);

INSERT INTO f12021.t_event (m_name) VALUES ('None');